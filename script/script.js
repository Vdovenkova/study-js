...
let appData = {
  ...
  addIncomeBlock: function(){
    ...
    // добавляются пустые поля
    cloneIncomeItems.querySelectorAll('input').forEach((elem)=> {
      elem.value = '';
    });
    // 
  ...
  addExpensesBlock: function(){
    ...
    // добавляются пустые поля
    cloneExpensesItems.querySelectorAll('input').forEach((elem)=> {
      elem.value = '';
    });
    // 
...
// поля сумма - ввод только цифр, наименование - русс.буквы и знаки преп.
